...
# In the notebook, both Internship_Experience_No and Internship_Experience_Yes were created.
user_input_processed = pd.get_dummies(user_input_df, columns=['Internship_Experience'], dtype=int)

# The columns in x_train (after all preprocessing) were:
...
# Add missing columns with default value 0 (e.g., if 'Internship_Experience_No' is not present because input was 'Yes')
